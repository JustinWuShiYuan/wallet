...
import com.tong.gao.wallet.adapter.holder.MyServiceItemHolder;
...
public class MyServiceFragment extends BaseFragment {
    ...
    class MyMessageListAdapter extends RecyclerView.Adapter<MyServiceItemHolder> {

        @NonNull
        @Override
        public MyServiceItemHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
            MyServiceItemHolder myMessageItemHolder = new MyServiceItemHolder(
                    LayoutInflater.from(getActivity()).inflate(R.layout.item_my_message, viewGroup, false), getActivity());

//            MyServiceItemHolder.getRootView().setOnClickListener(new View.OnClickListener() {
//                @Override
...
//            });
        ...
        @Override
        public void onBindViewHolder(@NonNull MyServiceItemHolder myServiceItemHolder, int index) {
            myServiceItemHolder.refreshUI(dataList.get(index));
        }
